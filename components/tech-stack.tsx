...
import {
  ChevronUp, Terminal, Settings2, ShieldCheck, Microscope,
  Cpu, Workflow, Globe, Zap, LayoutDashboard, BarChart3, Mail,
} from "lucide-react"
import {
  SiReact, SiNextdotjs, SiTypescript, SiTailwindcss,
  SiNodedotjs, SiPostgresql, SiPrisma, SiGit,
  SiDocker, SiPython, SiPopos, SiJavascript, SiHtml5, SiCss3,
  SiExpress, SiVercel, SiPostman, SiFlutter,
...
//   • Portfolio site (Next.js, Prisma, Tailwind, EmailJS, shadcn/ui)
//   • WebSocket Chat Server (Node.js, Express, ws, vanilla HTML/CSS/JS)
//   • Deployment (Vercel, Render, GitHub Pages, GitHub Actions)
//   • Security (Input sanitization, WCAG accessibility, OAuth/Okta)
//   • Observability (Datadog APM/Logs, PostHog analytics)
//   • MTN CoE (Directus, Scrum)
//   • Lelapa AI (AI/ML APIs, Python, React, Inclusive Design)
// ═══════════════════════════════════════════════════════════════
...
const TECH_STACK = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "shadcn/ui",    icon: LayoutDashboard, color: "#000000" },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "REST APIs",   icon: Globe,            color: "#10b981" },
      { name: "EmailJS",     icon: Mail,             color: "#FF6B6B" },
    ],
  },
  {
    category: "DevOps & QA",
    ...
    skills: [
      ...
      { name: "Render",         icon: Globe,              color: "#46E3B7" },
      { name: "GitHub Pages",   icon: Globe,              color: "#222222" },
      { name: "Docker",         icon: SiDocker,           color: "#2496ED" },
      { name: "Linux",          icon: SiPopos,            color: "#48B9C7" },
      { name: "Postman",        icon: SiPostman,          color: "#FF6C37" },
      { name: "TDD",            icon: ShieldCheck,        color: "#8b5cf6" },
      { name: "Unit Testing",   icon: SiTestinglibrary,   color: "#E33332" },
      { name: "Input Sanitization", icon: ShieldCheck,    color: "#10b981" },
      { name: "Debugging",      icon: Terminal,            color: "#64748b" },
    ],
  },
  {
    category: "Methodology & Platforms",
    variant: "rose",
    skills: [
      { name: "Scrum",         icon: Workflow,          color: "#e11d48" },
      { name: "Agile",         icon: Settings2,         color: "#f43f5e" },
      { name: "Directus",      icon: LayoutDashboard,   color: "#6644FF" },
      { name: "OAuth/Okta",    icon: ShieldCheck,       color: "#00297A" },
      { name: "PostHog",       icon: BarChart3,         color: "#F9BD2B" },
      { name: "Datadog",       icon: Microscope,        color: "#632CA6" },
      { name: "WCAG A11y",     icon: Globe,             color: "#0284c7" },
      { name: "AI/ML",         icon: Cpu,               color: "#10b981" },
          ...
          return (
            ...
            >
              ...
              >
                ...
                <div
                  className={`p-1.5 rounded-full ${colors.bg} ${colors.text} transition-all duration-300 ${isOpen ? "" : "rotate-180 opacity-50"}`}
                >
                  <ChevronUp size={20} />
                </div>
              </button>
              ...
              >
                {group.skills.map((skill) => {
                  ...
                  return (
                    <div key={skill.name} className="group flex flex-col items-center w-20 md:w-24 shrink-0">
                      <div
                        className={`
